    ...
    if (req.method === "POST") {
        ...
        if (chat) {
            ...
            for (const chunk of chunks) {
                ...
                let prompt = `Este é um pedaço de legenda de um vídeo do youtube:\n
                ...
                if (forCounter == 1) {
                    ...
                    prompt = `Este é um pedaço de legenda de um vídeo do youtube:\n
                    ${firstChunkString}\n\n
                ...
                if (counter == 3) {
                    ...
                    ${article}\n\n
                    Este é um trecho de um artigo reescrito com titulo e subtitulo(nenhum autor deve ser nomeado):\n
                    ` ;
